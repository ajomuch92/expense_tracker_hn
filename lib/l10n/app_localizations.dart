...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _values = {
    ...
    'notesHint': {
      'es': '¿En qué gastaste este dinero?',
      'en': 'What did you spend this money on?',
    },
    ...
    'categoryNameHint': {
      'es': 'Ej. Restaurantes, Gimnasio...',
      'en': 'E.g. Restaurants, Gym...',
    },
    'description': {
    ...
    'descriptionHint': {
      'es': 'Agrega una nota sobre esta categoría...',
      'en': 'Add a note about this category...',
    },
    ...
    'noResultsFor': {
      'es': 'Sin resultados para "%s"',
      'en': 'No results for "%s"',
    },
    'autoColor': {
      'es': 'Automático (según nombre)',
      'en': 'Automatic (from name)',
    },
    ...
    'needMoreCategories': {
      'es': '¿Necesitas separar más tus gastos?',
      'en': 'Need to split your expenses further?',
    },
    'createCustomCategory': {
      'es': 'Crea una categoría personalizada.',
      'en': 'Create a custom category.',
    },
    ...
    'premiumDesc': {
      'es':
          'Exportaciones ilimitadas, sincronización en la nube y categorías personalizadas.',
    ...
    'confirmDeleteBody': {
      'es':
          'Esta acción no se puede deshacer. Los gastos asociados no se eliminarán.',
      'en':
          'This action cannot be undone. Associated expenses will not be deleted.',
    },
    ...
    'noCategories': {
      'es': 'Aún no tienes categorías',
      'en': "You don't have categories yet",
    },
...
extension AppStringsX on BuildContext {
  ...
  String trRead(String key, [List<String>? args]) =>
      AppStrings.ofRead(this, key, args);
}
